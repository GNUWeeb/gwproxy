...
LIBGWDNS_CACHE_TEST_TARGET = $(GWPROXY_DIR)/tests/dns_cache.t
LIBGWDNS_CACHE_TEST_CC_SOURCES = $(GWPROXY_DIR)/tests/dns_cache.c
LIBGWDNS_CACHE_TEST_OBJECTS = $(LIBGWDNS_CACHE_TEST_CC_SOURCES:%.c=%.c.o)

ALL_TEST_TARGETS = $(LIBGWDNS_TEST_TARGET) $(LIBGWDNS_CACHE_TEST_TARGET) $(LIBGWPSOCKS5_TEST_TARGET)
ALL_OBJECTS = $(GWPROXY_OBJECTS) $(LIBGWPSOCKS5_OBJECTS) $(LIBGWDNS_OBJECTS) $(LIBGWDNS_TEST_OBJECTS) $(LIBGWDNS_CACHE_TEST_OBJECTS) $(LIBGWPSOCKS5_TEST_OBJECTS)
...
$(LIBGWDNS_CACHE_TEST_TARGET): $(LIBGWDNS_CACHE_TEST_OBJECTS) $(LIBGWDNS_TARGET)
	$(CC) $(LDFLAGS) -o $@ $^ $(LIBS)
...
test: $(LIBGWDNS_TEST_TARGET) $(LIBGWDNS_CACHE_TEST_TARGET) $(LIBGWPSOCKS5_TEST_TARGET)
	@echo "Running tests...";
	@echo "Testing libgwdns...";
	@$(IE) ./$(LIBGWDNS_TEST_TARGET);
	@echo "Testing libgwdns cache...";
	@$(IE) ./$(LIBGWDNS_CACHE_TEST_TARGET);
